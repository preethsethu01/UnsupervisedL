...
visualize_rawdata(raw_data_train['sepal-length'],raw_data_train['sepal-width'],'Feature_1','Feature_2')

visualize_rawdata(raw_data_train['petal-length'],raw_data_train['petal-width'],'Feature_1','Feature_2')
...
giris = mixture.GaussianMixture(n_components=2,covariance_type = 'full')
