...
nn_model_predict = nn_model.predict(X_train_std)

print "$$$$$$$$$ Neural Network Accuracy $$$$$$$$$$$$$$"
print accuracy_score(Y_train,nn_model_predict)

nn_model_test = nn_model.predict(X_test_std)

print accuracy_score(Y_validation,nn_model_test)
