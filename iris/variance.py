...
X_train_new = Kbest_fit.transform(X_train_std)
print X_train_new.shape
X_test_new = Kbest_fit.transform(X_test_std)
...
pred_y_train = kmeans.fit_predict(X_train_new)
print pred_y_train
print "K Means Train Accuracy"
print accuracy_score(Y_train_encoded,pred_y_train)

visualize_clusters(X_train_new,pred_y_train,kmeans,'Feature_1','Feature_2')



pred_y_test = kmeans.fit_predict(X_test_new)
print pred_y_test
...
giris.fit(X_train_new)
labels_train  = giris.predict(X_train_new)
...
labels_test = giris.predict(X_test_new)
print "Test Accuracy"
...
nn_model_predict = nn_model.predict(X_test_new)
